...
#endif
/*-----------------------------------------------------------*/
//Defined in SmartStart32.S
extern void restore_context(void);

portBASE_TYPE xPortStartScheduler(void)
{
	/* Start the ARM timer that generates the tick ISR.  Interrupts are disabled
	here already. The ARM timer handler calls freeRTOS each tick */
	SetupTickInterrupt();
