...
void SetupDMAInterrupt();
void SetupEMMCInterrupt();
...
//Entry points called through SmartStart32
void irqHandler(void);
void swiHandler(void);
void fiqHandler(void);

//IRQ definitions From RPi Circle project (bit numbers) -- most not documented in RPi official manuals...
//use (1<<ARM_IRQ_XXX) to get and/or bit mask
...
#define ARM_IRQ2_BASE		0 //RasROS because of how we shift differently than Circle's system in bcm2835.h //(ARM_IRQ1_BASE + ARM_IRQS_PER_REG)
...
#if RASPPIVersion >= 2  //Only available on Rasp Pi version 2 and above!
